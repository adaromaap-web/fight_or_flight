...
style scrollbar:
    ...
    base_bar Frame(
        "gui/scrollbar/horizontal_[prefix_]bar.png",
        gui.scrollbar_borders,
        tile=gui.scrollbar_tile
    )
    thumb Frame(
        "gui/scrollbar/horizontal_[prefix_]thumb.png",
        gui.scrollbar_borders,
        tile=gui.scrollbar_tile
    )
...
style slider:
    ...
    base_bar Frame(
        "gui/slider/horizontal_[prefix_]bar.png",
        gui.slider_borders,
...
style vslider:
    ...
    base_bar Frame(
        "gui/slider/vertical_[prefix_]bar.png",
        gui.vslider_borders,
        tile=gui.slider_tile
    )
...
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc") or (
            renpy.variant("web") and not renpy.variant("mobile")
        ):
...
define bubble.frame = Frame(
    "gui/bubble.png",
    55, 55, 55, 95
)

define bubble.thoughtframe = Frame(
...
style scrollbar:
    ...
    base_bar Frame(
        "gui/phone/scrollbar/horizontal_[prefix_]bar.png",
        gui.scrollbar_borders,
        tile=gui.scrollbar_tile
    )

    thumb Frame(
        "gui/phone/scrollbar/horizontal_[prefix_]thumb.png",
        gui.scrollbar_borders,
        tile=gui.scrollbar_tile
    )
...
style vscrollbar:
    ...
    base_bar Frame(
        "gui/phone/scrollbar/vertical_[prefix_]bar.png",
        gui.vscrollbar_borders,
        tile=gui.scrollbar_tile
    )

    thumb Frame(
        "gui/phone/scrollbar/vertical_[prefix_]thumb.png",
        gui.vscrollbar_borders,
        tile=gui.scrollbar_tile
    )
...
style slider:
    ...
    base_bar Frame(
        "gui/phone/slider/horizontal_[prefix_]bar.png",
        gui.slider_borders,
        tile=gui.slider_tile
    )
...
style vslider:
    ...
    base_bar Frame(
        "gui/phone/slider/vertical_[prefix_]bar.png",
        gui.vslider_borders,
        tile=gui.slider_tile
    )
